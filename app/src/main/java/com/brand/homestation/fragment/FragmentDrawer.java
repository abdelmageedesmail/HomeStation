...
import com.brand.homestation.trader_activities.TraderProfileActivity;
...
public class FragmentDrawer extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        name=(TextView) layout.findViewById(R.id.nameNav);
        email= (TextView) layout.findViewById(R.id.nameEmail);
        ...
        UtilitiesClass.setFont(name,getActivity(),0);
        UtilitiesClass.setFont(email,getActivity(),0);
        ...
        name.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(getActivity(), TraderProfileActivity.class));
            }
        });
        return layout;
    }
